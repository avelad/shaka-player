...
shaka.text.SpeechToText = class {
  ...
  constructor(player) {
    ...
    /** @private {boolean} */
    this.supported_ = this.isMediaStreamTrackSupported_();
  ...
  onAudioTrackChange_() {
    ...
    if (audioTracks.length) {
      const audioTrack = this.getAudioTrackFromMediaElement_();
      if (!audioTrack) {
        return;
      }
      ...
      this.recognition_.start(audioTrack);
    }
  }
